...
// project imports
import ProductAdd from './TerminalAdd';
...
const ProductList = () => {
    ...
    const fetchData = async () => {
        const [jsonData, jsonDataStatus] = await TerminalHelper.fetchData();
        console.log(jsonDataStatus);

        console.log('Este es el status :',jsonData.status);
        setRows(jsonData);
    };
    React.useEffect(() => {
        fetchData();
    ...
    const handleEdit = async (id, description) => {
        ...
        console.log(`El fwette ${description} con ${id}, ha sido Editado`)
    };
    ...
    const handleUpdate = async (id) => {
        ...
        await TerminalHelper.updateDataById(id, registro);
                                                ...
                                                <>
                                                    <TableCell>
                                                        <TextField
                                                            ...
                                                            placeholder='Ingrese la modificacion de fwette'
