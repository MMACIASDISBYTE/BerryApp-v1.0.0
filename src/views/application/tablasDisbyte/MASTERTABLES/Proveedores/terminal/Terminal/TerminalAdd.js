...
const ProductAdd = ({ open, handleCloseDialog }) => {
    ...
    const handleAdd = () => {
        const newData = {
          ...
          TerminalHelper.createData(newData) // Pasar el nombre del data al manejador handleAdd en Fwdtte.js
            .then((response) => {
    ...
    return (
        ...
        >
            {open && (
                <>
                    <DialogTitle>Add Fwdtte</DialogTitle>
                    <DialogContent>
                        <Grid container spacing={gridSpacing} sx={{ mt: 0.25 }}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    placeholder='Ingrese el nombre de fwdtte'
                                    value={dataName}
