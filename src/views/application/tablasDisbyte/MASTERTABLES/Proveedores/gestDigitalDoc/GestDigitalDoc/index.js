...
// project imports
import ProductAdd from './GestionDigitalDocAdd';
...
const ProductList = () => {
    ...
    const [rows, setRows] = React.useState([]); //estoy almacenando la data GestDigital
    ...
    // traigo data de GestDigital Y LO ALMACENO EN EL STATE DE setRows
    ...
    const handleEdit = async (id, description) => {
        ...
        console.log(`El GestDigital ${description} con ${id}, ha sido Editado`)
    };
    ...
    const handleUpdate = async (id) => {
        ...
        await GestDigitalDocHelper.updateDataById(id, registro);
                                                ...
                                                <>
                                                    <TableCell>
                                                        <TextField
                                                            ...
                                                            // defaultValue="Ingrese el nombre de GestDigital"
                                                            placeholder='Ingrese la modificacion de GestDigital'
