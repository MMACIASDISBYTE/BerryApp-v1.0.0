...
// project imports
import ProductAdd from './DespachanteAdd';
...
const ProductList = () => {
    ...
    const handleEdit = async (id, description) => {
        ...
        console.log(`El Despachante ${description} con ${id}, ha sido Editado`)
    };
    ...
    const handleUpdate = async (id) => {
        ...
        await DespachanteHelper.updateDataById(id, registro);
    ...
    return (
        <MainCard title="Fwdtte List" content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    <Grid item xs={12} sm={6}>
                        <TextField
                            ...
                            placeholder="Search Despachante"
                            value={search}
                            size="small"
                        />
                    </Grid>
                                                ...
                                                <>
                                                    <TableCell>
                                                        <TextField
                                                            ...
                                                            placeholder='Ingrese la modificacion de Despachante'
