...
// project imports
import ProductAdd from './ProveedoresOemAdd';
...
const ProductList = () => {
    ...
    const handleUpdate = async (id) => {
        ...
        await ProveedoresOemHelper.updateDataById(id, registro);
    ...
    return (
        <MainCard title="ProveedoresOem List" content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    <Grid item xs={12} sm={6}>
                        <TextField
                            ...
                            placeholder="Search ProveedoresOem"
                            value={search}
                            size="small"
                        />
                    </Grid>
