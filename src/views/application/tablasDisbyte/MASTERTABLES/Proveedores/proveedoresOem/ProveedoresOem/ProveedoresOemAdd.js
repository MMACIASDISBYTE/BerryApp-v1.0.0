...
const ProductAdd = ({ open, handleCloseDialog }) => {
    ...
    const handleAdd = () => {
        const newData = {
          ...
          ProveedoresOemHelper.createData(newData) // Pasar el nombre del data al manejador handleAdd
            .then((response) => {
    ...
    return (
        ...
        >
            {open && (
                <>
                    <DialogTitle>Add Proveedores Oem</DialogTitle>
                    <DialogContent>
                        <Grid container spacing={gridSpacing} sx={{ mt: 0.25 }}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    id="outlined-basic1"
                                    fullWidth label="Enter ProveedoresOem Name*"
                                    // defaultValue="Ingrese el nombre de Proveedores Oem"
                                    placeholder='Ingrese el nombre de Proveedores Oem'
                                    value={dataName}
