...
const ProductAdd = ({ open, handleCloseDialog }) => {
    ...
    const handleAdd = () => {
        const newData = {
          ...
          PolizaHelper.createData(newData) // Pasar el nombre del data al manejador handleAdd en Poliza.js
            .then((response) => {
    ...
    return (
        ...
        >
            {open && (
                <>
                    <DialogTitle>Add Poliza</DialogTitle>
                    <DialogContent>
                        <Grid container spacing={gridSpacing} sx={{ mt: 0.25 }}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    id="outlined-basic1"
                                    fullWidth label="Enter Poliza Name*"
                                    // defaultValue="Ingrese el nombre de Poliza"
                                    placeholder='Ingrese el nombre de Poliza'
                                    value={dataName}
