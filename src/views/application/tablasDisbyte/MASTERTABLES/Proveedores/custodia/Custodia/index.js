...
// project imports
import ProductAdd from './CustodiaAdd';
...
const ProductList = () => {
    ...
    const handleUpdate = async (id) => {
        ...
        await CustodiaHelper.updateDataById(id, registro);
    ...
    return (
        <MainCard title="Custodia List" content={false}>
            <CardContent>
