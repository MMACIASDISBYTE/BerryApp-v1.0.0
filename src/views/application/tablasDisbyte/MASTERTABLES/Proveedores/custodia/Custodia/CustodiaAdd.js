...
const ProductAdd = ({ open, handleCloseDialog }) => {
    ...
    const handleAdd = () => {
        const newData = {
          ...
          CustodiaHelper.createData(newData) // Pasar el nombre del data al manejador handleAdd
            .then((response) => {
    ...
    return (
        ...
        >
            {open && (
                <>
                    <DialogTitle>Add Custodia</DialogTitle>
                    <DialogContent>
                        <Grid container spacing={gridSpacing} sx={{ mt: 0.25 }}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    id="outlined-basic1"
                                    fullWidth label="Enter Custodia Name*"
                                    // defaultValue="Ingrese el nombre de Custodia"
                                    placeholder='Ingrese el nombre de Custodia'
                                    value={dataName}
