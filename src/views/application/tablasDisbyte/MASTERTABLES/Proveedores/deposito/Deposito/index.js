...
// project imports
import ProductAdd from './DepositosAdd';
...
const ProductList = () => {
    ...
    const handleEdit = async (id, description) => {
        ...
        console.log(`El Deposito ${description} con ${id}, ha sido Editado`)
    };
    ...
    const handleUpdate = async (id) => {
        ...
        await DepositoHelper.updateDataById(id, registro);
                                                ...
                                                <>
                                                    <TableCell>
                                                        <TextField
                                                            ...
                                                            placeholder='Ingrese la modificacion de Deposito'
