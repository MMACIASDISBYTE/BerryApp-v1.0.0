...
// project imports
import ProductAdd from './SeguroAdd'; 
...
const ProductList = () => {
    ...
    const handleEdit = async (id, description) => {
        ...
        console.log(`El Seguro ${description} con ${id}, ha sido Editado`)
    };
    ...
    const handleUpdate = async (id) => {
        ...
        await SeguroHelper.updateDataById(id, registro);
    ...
    return (
        <MainCard title="Seguro List" content={false}>
            <CardContent>
