...
const ProductAdd = ({ open, handleCloseDialog }) => {
    ...
    const handleAdd = () => {
        const newData = {
          ...
          FleteHelper.createData(newData) // Pasar el nombre del data al manejador handleAdd
            .then((response) => {
    ...
    return (
        ...
        >
            {open && (
                <>
                    <DialogTitle>Add Flete</DialogTitle>
                    <DialogContent>
                        <Grid container spacing={gridSpacing} sx={{ mt: 0.25 }}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    id="outlined-basic1"
                                    fullWidth label="Enter Flete Name*"
                                    // defaultValue="Ingrese el nombre de fwdtte"
                                    placeholder='Ingrese el nombre de Flete'
                                    value={dataName}
