...
// project imports
import ProductAdd from './FleteAdd';
...
const ProductList = () => {
    ...
    const handleEdit = async (id, description) => {
        ...
        console.log(`El Flete ${description} con ${id}, ha sido Editado`)
    };
    ...
    const handleUpdate = async (id) => {
        ...
        await FleteHelper.updateDataById(id, registro);
                                                ...
                                                <>
                                                    <TableCell>
                                                        <TextField
                                                            ...
                                                            placeholder='Ingrese la modificacion de Flete'
