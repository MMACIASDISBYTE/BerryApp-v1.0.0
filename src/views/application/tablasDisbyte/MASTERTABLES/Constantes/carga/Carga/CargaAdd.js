...
const ProductAdd = ({ open, handleCloseDialog }) => {
    ...
    const handleAdd = () => {
        const newData = {
          ...
          CargaHelper.createData(newData) // Pasar el nombre del Carga al manejador handleAdd en Carga.js
            .then((response) => {
    ...
    return (
        ...
        >
            {open && (
                <>
                    <DialogTitle>Add Carga</DialogTitle>
                    <DialogContent>
                        <Grid container spacing={gridSpacing} sx={{ mt: 0.25 }}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    id="outlined-basic1"
                                    fullWidth label="Enter Carga Name*"
                                    // defaultValue="Ingrese el nombre de Carga"
                                    placeholder='Ingrese el nombre de Carga'
                                    value={dataName}
