...
// project imports
import ProductAdd from './CargaAdd';
...
const ProductList = () => {
    ...
    const handleEdit = async (id, description) => {
        ...
        console.log(`El Carga ${description} con ${id}, ha sido Editado`)
    };
    ...
    const handleUpdate = async (id) => {
        ...
        await CargaHelper.updateDataById(id, registro);
    ...
    return (
        <MainCard title="Carga List" content={false}>
            <CardContent>
                                                ...
                                                <>
                                                    <TableCell>
                                                        <TextField
                                                            ...
                                                            // defaultValue="Ingrese el nombre de Carga"
                                                            placeholder='Ingrese la modificacion de la Carga'
