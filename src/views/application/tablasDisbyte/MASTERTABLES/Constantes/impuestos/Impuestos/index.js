...
// project imports
import ProductAdd from './ImpuestosAdd';
...
const ProductList = () => {
    ...
    const handleEdit = async (id, description) => {
        ...
        console.log(`El Impuesto ${description} con ${id}, ha sido Editado`)
    };
    ...
    const handleUpdate = async (id) => {
        ...
        await ImpuestoHelper.updateDataById(id, registro);
    ...
    return (
        <MainCard title="Impuesto List" content={false}>
            <CardContent>
                                                ...
                                                <>
                                                    <TableCell>
                                                        <TextField
                                                            ...
                                                            // defaultValue="Ingrese el nombre de Impuesto"
                                                            placeholder='Ingrese la modificacion de la Impuesto'
