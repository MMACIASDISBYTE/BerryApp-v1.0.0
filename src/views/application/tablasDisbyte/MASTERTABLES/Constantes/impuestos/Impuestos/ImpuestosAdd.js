...
const ProductAdd = ({ open, handleCloseDialog }) => {
    ...
    const handleAdd = () => {
        const newData = {
          ...
          ImpuestoHelper.createData(newData) // Pasar el nombre del Impuesto al manejador handleAdd en Impuesto.js
            .then((response) => {
    ...
    return (
        ...
        >
            {open && (
                <>
                    <DialogTitle>Add Impuesto</DialogTitle>
                    <DialogContent>
                        <Grid container spacing={gridSpacing} sx={{ mt: 0.25 }}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    id="outlined-basic1"
                                    fullWidth label="Enter Impuesto Name*"
                                    // defaultValue="Ingrese el nombre de Impuesto"
                                    placeholder='Ingrese el nombre de Impuesto'
                                    value={dataName}
