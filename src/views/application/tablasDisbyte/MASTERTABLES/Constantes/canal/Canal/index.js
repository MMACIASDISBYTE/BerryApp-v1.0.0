...
const ProductList = () => {
    ...
    const fetchData = async () => {
        const jsonData = await CanalHelper.fetchData();
        setRows(jsonData);
    };
    React.useEffect(() => {
        fetchData();
    ...
    const handleEdit = async (id, description) => {
        ...
        SetActualizacion(true);
        console.log(`El Canal ${description} con ${id}, ha sido Editado`)
    };
    ...
    const handleUpdate = async (id) => {
        ...
        await CanalHelper.updateDataById(id, registro);
                                                ...
                                                <>
                                                    <TableCell>
                                                        <TextField
                                                            ...
                                                            // defaultValue="Ingrese el nombre de canal"
                                                            placeholder='Ingrese la modificacion de Canal'
