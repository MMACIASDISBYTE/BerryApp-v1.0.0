                                    ...
                                    <Grid container spacing={1}>
                                        ...
                                        <Grid item xs={12}>
                                            <Grid container spacing={0}>
                                                ...
                                                <Grid item xs={12}>
                                                    <Typography variant="body2">Dolar Billete: ${presupuestador.dolarBillete}</Typography>
                                                </Grid>
                                                {/* <Grid item xs={12}>
                                                    <Typography component={Link} to="#" variant="body2" color="primary">
                                                        demo@company.com
                                    ...
                                    <TableBody>
                                        {presupuestador.estDetails.map((row, index) => (
                                            <TableRow key={index}>
                                                ...
                                                <TableCell align="right">u$s{(row.fobunit).toFixed(2)}</TableCell>
                                                <TableCell align="right" sx={{ pr: 3 }}>u$s{(row.fob).toFixed(2)}</TableCell>
                                                
                                                <TableCell align="right">u$s{(row.cif).toFixed(2)}</TableCell>
                                        ...
                                        <Grid container spacing={2}>
                                                ...
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Typography align="right" variant="body2">
                                                            u$s {presupuestador.fobGrandTotal.toFixed(2)}
                                                        </Typography>
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <Typography align="right" variant="subtitle1">
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Typography align="right" variant="body2">
                                                            u$s {presupuestador.pagado.toFixed(2)}
                                                        </Typography>
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <Typography align="right" variant="subtitle1">
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Typography align="right" variant="body2">
                                                            u$s {presupuestador.fleteTotal.toFixed(2)}
                                                        </Typography>
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <Typography align="right" variant="subtitle1">
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Typography align="right" variant="body2">
                                                            u$s {presupuestador.seguro.toFixed(2)}
                                                        </Typography>
                                                    </Grid>
                                                    {/* <Grid item xs={6}>
                                                        <Typography align="right" variant="subtitle1">
                                            ...
                                            <Grid item xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Typography align="right" color="primary" variant="subtitle1">
                                                            u$s {(presupuestador.cifTot).toFixed(2)}
                                                        </Typography>
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <Typography align="right" color="primary" variant="subtitle1">
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Typography align="right" color="primary" variant="subtitle1">
                                                            $ {(presupuestador.cifTot).toFixed(2) * presupuestador.dolarBillete}
                                                        </Typography>
                                                    </Grid>
                                                </Grid>
                                            </Grid>
