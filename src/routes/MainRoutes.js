...
const AppTerminalProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Proveedores/terminal/Terminal')));
// application --> proveedores - fwdtte routing
const AppFwdtteProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Proveedores/fwdtte/Fwdtte')));
// application --> proveedores - Custodia routing
const AppCustodiaProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Proveedores/custodia/Custodia')));
// application --> proveedores - Flete routing
const AppFleteProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Proveedores/flete/Flete')));
// application --> proveedores - Despachante routing
const AppDespachanteProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Proveedores/despachante/Despachante')));
// application --> proveedores - Deposito routing
const AppDepositoProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Proveedores/deposito/Deposito')));
// application --> proveedores - Deposito routing
const AppGestDigitalDocProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Proveedores/gestDigitalDoc/GestDigitalDoc')));
// application --> proveedores - Deposito routing
const AppPolizaProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Proveedores/poliza/Poliza')));
// application --> proveedores - Deposito routing
const AppProveedorOemProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Proveedores/proveedoresOem/ProveedoresOem')));

// application --> proveedores - Seguro routing
const AppProveedorSeguro = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Proveedores/seguros/seguros')));
...
const AppIIBB = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/IIBB/IIBB')));
...
const AppCanalProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Constantes/canal/Canal')));
// application --> Constantes - carga routing
const AppCargaProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Constantes/carga/Carga')));
// application --> Constantes - Impuestos routing
const AppImpuestosProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Constantes/impuestos/Impuestos')));
// application --> Constantes - Impuestos routing
const AppConstProduct = Loadable(lazy(() => import('views/application/tablasDisbyte/MASTERTABLES/Constantes/CONST/CONST')));
